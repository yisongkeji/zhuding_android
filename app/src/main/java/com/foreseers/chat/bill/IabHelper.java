...
package com.foreseers.chat.bill;
...
public class IabHelper {
     ...
     * 创建一个实例。在创建之后，它还没有准备好使用。你必须执行
     * 通过调用{@link #startSetup}进行安装，并等待安装完成。这个构造函数没有
     * 块，可以安全地从UI线程调用。
     ...
     * 安装过程的回调。调用此侦听器的{@link #onIabSetupFinished}方法
     * 当安装过程完成时。
     */
     ...
     * 配置对象，释放资源。如果有正在进行的异步操作，则执行此操作
     * 方法将对操作完成后发生的dispose进行排队。
     */
