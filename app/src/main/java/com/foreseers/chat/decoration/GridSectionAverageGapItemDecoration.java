package com.foreseers.chat.decoration;
...
public class GridSectionAverageGapItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        Log.i("TAG", "getItemOffsets: "+parent.getLayoutManager().toString() );

        if (parent.getLayoutManager() instanceof StaggeredGridLayoutManager && parent.getAdapter() instanceof BaseQuickAdapter) {
